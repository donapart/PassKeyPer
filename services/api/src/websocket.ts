...
async function handleAuth(ws: AuthenticatedWebSocket, token: string, deviceId?: string) {
    try {
        // Verify JWT
...
async function handleSyncRequest(ws: AuthenticatedWebSocket, message: any) {
...
async function handleItemUpdate(ws: AuthenticatedWebSocket, message: any) {
 ...
 */
function broadcastToUser(userId: string, message: any, exclude?: WebSocket) {
