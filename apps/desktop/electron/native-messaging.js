...
class NativeMessagingHost {
    ...
    async handleMessage(message) {
        ...
        ipc.connectTo('passkeyper-desktop', () => {
            ...
            const handleCredentials = (data) => handleResponse('CREDENTIALS', data);
            const handleSaved = (data) => handleResponse('SAVED', data);
            const handleError = (data) => handleResponse('ERROR', data);
