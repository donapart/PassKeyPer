...
export class IpcServer {
    ...
    start() {
        ipc.serve(() => {
            ipc.server.on('GET_CREDENTIALS', async (payload, socket) => {
                try {
            ...
            ipc.server.on('SAVE_CREDENTIALS', async (payload, socket) => {
