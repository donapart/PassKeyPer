...
export function useSync() {
    const { authToken, syncSettings, setVaults, setTeams, setItems, updateLastSync, isAuthenticated, encryptionKey, fetchTeams: storeFetchTeams } = useMobileStore();
    ...
    const fetchItems = useCallback(async (vaultId) => {
