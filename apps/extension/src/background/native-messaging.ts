...
class NativeMessagingClient {
     ...
     */
    async sendMessage(message: NativeMessage): Promise<NativeResponse> {
...
export async function getCredentials(url: string) {
    try {
...
export async function saveCredentials(url: string, username: string, password: string) {
    try {
