...
function addPassKeyPerIcons() {
    ...
    passwordFields.forEach((field) => {
        ...
        if (field.dataset.passkeyper === 'true')
            return;
...
// Show autofill menu
function showAutofillMenu(field) {
...
function createAutofillMenu(field, credentials) {
...
// Fill credentials
function fillCredentials(passwordField, credentials) {
...
function setupFormAutoSave() {
    ...
    forms.forEach(form => {
        ...
        if (form.dataset.passkeyperAutosave === 'true')
            return;
