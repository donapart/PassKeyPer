...
export type ItemType = 'login' | 'note' | 'card' | 'identity' | 'api_key' | 'ssh_key' | 'passkey';
...
export type DecryptedItem = LoginItem | SecureNote | CreditCard | Identity | ApiKey | SshKey | Passkey;
